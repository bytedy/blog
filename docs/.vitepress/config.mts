...
//    },
        ...
        nav: [
            {text: 'Home', link: '/'},
            {
                ...
                items: [
                    ...
                    {text: 'OpenTelemetry', link: '/posts/programming/otel/', /*activeMatch: '^/posts/golang/' */},
                ]
            },
            {
                text: 'DevOps',
        ...
        sidebar: {
            ...
            '/posts/programming/otel/': {
                items: [
                    {
                        text: 'LOG',
                        collapsed: false,
                        items: [
                            {text: 'Log | Golang', link: '/posts/programming/otel/log.md'},
                        ],
                    },
                    {
                        text: 'TRACE',
                        collapsed: false,
                        items: [
                            {text: 'Trace | Golang', link: '/posts/programming/otel/trace.md'},
                        ],
                    },
                    {
                        text: 'METRIC',
                        collapsed: false,
                        items: [
                            {text: 'Metric | Golang', link: '/posts/programming/otel/metric.md'},
                        ],
                    },
